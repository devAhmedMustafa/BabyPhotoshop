...
namespace Filters {
    ...
    void AddFancyFrame(Image& image, int thickness, const int color[], const int minorColor[]) {
        ...
        square[0] = new int[2] {1, 1};
        square[1] = new int[2] {1, 1};

        int** hollowSquare = new int* [4];
        hollowSquare[0] = new int[4] {0, 0, 0, 1};
        hollowSquare[1] = new int[4] {0, 0, 0, 1};
        hollowSquare[2] = new int[4] {0, 0, 0, 1};
        hollowSquare[3] = new int[4] {1, 1, 1, 1};
